      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ¿Listo para vivir una experiencia única en el eje cafetero? Completa el formulario y te
            ayudaremos a diseñar la aventura perfecta para ti.
          </p>
        </div>
                ...
                {isSubmitting ? (
                  <>
                    <svg className="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24">
                      <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentntColor" strokeWidth="4" />
